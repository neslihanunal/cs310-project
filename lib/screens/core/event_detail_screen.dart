...
class EventDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isAttending = event.isAttendingBy(currentUid);
    final colors = AppColors.postit[event.colorSeed % AppColors.postit.length];
                  ...
                  if (!isAdmin)
                    GestureDetector(
                      onTap: currentUid == null
                          ? null
                          : () => eventProvider.toggleSave(event.id, currentUid),
                      child: Container(
                        width: 34,
                        height: 34,
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(_catIcon(event.cat), color: colors.pin, size: 11),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            ).copyWith(height: 1.65, letterSpacing: -0.01),
                          ),
                        ],
                      ),
                    ),
