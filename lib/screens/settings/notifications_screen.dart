...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final reminderCopy = isAdmin
        ...
        : 'Saved-event reminders are currently set to ${authProvider.reminderLabel} before start.';
                    ...
                    child: Column(
                      children: rows.asMap().entries.map((entry) {
                        ...
                        return GestureDetector(
                          onTap: () => setState(() {
                            _settings[row.$1] = !(_settings[row.$1] ?? false);
                          }),
                          child: Container(
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          const TextSpan(
                            text: 'Push notifications appear on this device and inside ',
                          ),
                          TextSpan(
                            text: 'CampusBoard',
